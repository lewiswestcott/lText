...
<body class="bg-dark">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-warning">
        <div class="container">
            ...
            <a class="navbar-brand" href="../index.php">LText</a>
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="../index.php">Reset</a>
                    </li>

                </ul>
                <span class="navbar-text" href="lewiswestcott.co.uk">
                    lewiswestcott.co.uk
                </span>
            </div>
        </div>
